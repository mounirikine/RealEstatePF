...
const Video = () => {
  ...
  return (
    ...
    <section className="flex items-center justify-center relative px-10">
      ...
      <div className=" absolute flex  w-[80%] mx-auto ">
        <div className="w-6/12 pt-5">
          ...
          initial="hidden"
          whileInView="show"
          transition={{ duration: 0.5, delay: 0.25 }}  className="text-5xl font-bold mb-4">Comfort Is Our Top Priority For You</motion.h1>
          <motion.p                    variants={{
            hidden: { opacity: 0,x:-33  },
            show: { opacity: 1,x:0  },
          }}
          initial="hidden"
          whileInView="show"
          transition={{ duration: 0.5, delay: 0.75 }} className="text-lg mt-3">We guarantee that the products we sell will make our customers happy because we are very concerned about our consumer satisfaction</motion.p>
        </div>

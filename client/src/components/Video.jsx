...
const Video = () => {
  return (
    <div className="relative px-8 sm:px-6 lg:px-8 py-20 ">
      ...
      <div className="absolute rounded-xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full sm:w-5/6 md:w-2/3 lg:w-5/12 options px-4 sm:px-6 lg:px-8 py-10 bg-white">

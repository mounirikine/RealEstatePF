const Hero = () => {
  return (
    <main className="py-20 px-4  md:px-10 lg:px-20 xl:px-32 bg-violet-500">
      <div className="flex flex-col md:flex-row justify-between items-center py-10 px-4 md:px-14">
        <div className="w-full md:w-6/12 lg:w-7/12 xl:w-6/12 mb-10 md:mb-0">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 md:mb-10">
          ...
          <div className="py-10">
            <span className="bg-white px-5 py-2 rounded-xl flex justify-between ">
                <input type="text" placeholder="Search for city, properties, cars ..."  className="w-8/12 text-black outline-none text-[17px]"/>
                <button className=' cursor-pointer font-semibold text-slate-700 rounded-xl hover:bg-[#8def7b] text-[17px] bg-[#7af065] px-10 py-3  '>Search</button>

            </span>
          </div>
          </div>
        </div>
        <div className="w-full flex items-center justify-center md:w-5/12 lg:w-4/12 xl:w-5/12 relative ">
        <div>
        <svg
          ...
          >
            <circle
              ...
              cy="450"
              r="449.5"
              stroke="url(#paint0_linear_1182_40697)"
            />
            <circle
              cx="450"
              cy="450"

    ...
    <>
      <section className="flex items-center gap-8 lg:gap-1  py-5 px-5 sm:px-0 lg:px-10">
        ...
        className="w-full lg:w-1/2  px-5">
          ...
          <p className="font-bold text-base sm:text-lg text-gray-500 pb-5 sm:pb-10">
            ...
            suspendisse massa. Venenatis imperdiet mauris lacus justo, hac
            nibh. Cursus in et odio at at commodo.
          </p>

          <Link
            to="/"
            className="secondary_color cursor-pointer text-white px-10 sm:px-20 py-2 sm:py-3 rounded-xl font-bold"
          >
            To Catalog
          </Link>
        </motion.div>

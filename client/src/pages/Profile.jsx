          ...
          <div className="w-full border-2 border-black px-6 mx-auto pb-8 mt-8 sm:max-w-2xl sm:rounded-lg bg-white mb-14">
            <div className="grid max-w-4xl mx-auto  ">
              <div className=" flex-col items-center justify-center gird py-5 w-full space-y-5 sm:flex-row sm:space-y-0">
                ...
                <div className="flex flex-col space-y-5 sm:ml-8">
                  <div className="flex items-center justify-center">
                    <button
                      ...
                      disabled={active}
                      className="py-3.5 px-7 w-4/12 mx-auto text-base font-medium text-indigo-100 focus:outline-none bg-violet-900 rounded-lg border border-indigo-200 hover:bg-indigo-900 focus:z-10 focus:ring-4 focus:ring-indigo-200 "
                    >
                      {t("Change picture")}
                    </button>

                    <button
                      className=" py-3.5 px-7 w-4/12 mx-auto text-base font-medium  focus:outline-none bg-violet-200 rounded-lg border border-indigo-200 text-black   focus:z-10 focus:ring-4  "
                      onClick={() =>
                ...
                <div className=" w-full flex items-center justify-center ">
                  ...
                  <div className=" w-full flex items-center   justify-center mt-3">
                    <h1 className="px-20  border-none rounded-lg   text-black ">
              ...
              <div className="items-center mt-8 sm:mt-14 text-[#202142]">
                <div className="grid grid-cols-2 items-center w-full mb-2 space-x-0 space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0 sm:mb-6">
                ...
                <div className="mb-2 ">
                  ...
                  <PhoneInput
                    inputProps={{
                      name: "phone",
                      className:
                        "bg-violet-100 pl-10 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 ",

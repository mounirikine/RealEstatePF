  ...
  return (
    <>
      ...
      <section className="text-black">
        ...
        <main className="px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8 lg:py-10">
  <div className="py-4 sm:py-6 md:py-8">
    <h1 className="text-center text-2xl sm:text-3xl md:text-4xl font-bold">Our Location</h1>
  </div>

  <div className="relative aspect-w-16 h ">

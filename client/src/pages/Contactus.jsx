...
<h1 className="text-center text-5xl font-bold mb-5">Contact Us</h1>
            <h1 className="text-center text-lg">Have any question? Fill out the form and we'll love to hear, we'll in touch shortly</h1>
</div>

<section
   className="relative border mt-5 bg-violet-100 z-10 overflow-hidden  rounded-2xl md:mx-5 dark:bg-dark px-10 py-10 lg:py-[120px]"

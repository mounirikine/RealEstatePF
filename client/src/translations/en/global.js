export const linksEn = {
    ...
    'login':'login',
    'register':'register',
    'contune_with_google':'contune_with_google',
    "Home":"Home",
    ...
    'FirstSectionTitle':'FIND THE CATEGORY FOR YOU',
    'FirstSectionDes':'Here you can find your categories that you are simply looking for and be the first to take them',
